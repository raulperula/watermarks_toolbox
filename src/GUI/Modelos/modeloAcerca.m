function varargout = modeloAcerca(varargin)
% MODELOACERCA M-file for modeloAcerca.fig
%      MODELOACERCA, by itself, creates a new MODELOACERCA or raises the existing
%      singleton*.
%
%      H = MODELOACERCA returns the handle to a new MODELOACERCA or the handle to
%      the existing singleton*.
%
%      MODELOACERCA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MODELOACERCA.M with the given input arguments.
%
%      MODELOACERCA('Property','Value',...) creates a new MODELOACERCA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before modeloAcerca_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to modeloAcerca_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help modeloAcerca

% Last Modified by GUIDE v2.5 18-Aug-2009 12:33:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @modeloAcerca_OpeningFcn, ...
                   'gui_OutputFcn',  @modeloAcerca_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before modeloAcerca is made visible.
function modeloAcerca_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to modeloAcerca (see VARARGIN)

% Choose default command line output for modeloAcerca
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes modeloAcerca wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = modeloAcerca_OutputFcn(hObject, eventdata, handles) 
